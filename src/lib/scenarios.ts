...
export const SCENARIOS: Scenario[] = [
  ...
  {
    name: 'BDB: Rodgers 57yd TD to Allison (real tracking)',
    description: '2018 week-1 NFL tracking (GB@CHI): 57-yard go touchdown, Fuller in trail, frame-exact timing. Timing from the 10Hz feed.',
    build: build(
      'BDB Explosive',
      [
        T('QB', 'offense', 'QB', 23.6, 53.8),
        T('WR1', 'offense', 'WR', 35.5, 50.5),
        T('WR2', 'offense', 'WR', 9.5, 50.0),
        T('WR3', 'offense', 'WR', 43.7, 50.9),
        T('TE', 'offense', 'TE', 28.9, 50.4),
        T('RB', 'offense', 'RB', 20.6, 54.0),
        T('CB1', 'defense', 'CB', 9.9, 47.0),
        T('CB2', 'defense', 'CB', 35.9, 47.6),
        T('CB3', 'defense', 'CB', 44.0, 48.6),
        T('FS', 'defense', 'S', 21.1, 33.5),
        T('SS', 'defense', 'S', 29.7, 44.0),
        T('LB1', 'defense', 'LB', 20.3, 45.4),
        T('LB2', 'defense', 'LB', 24.3, 45.2),
        T('LB3', 'defense', 'LB', 16.6, 48.6),
      ],
      [
        PBDB('QB', 'drop', [[23.6, 53.8], [23.5, 55.1], [23.3, 57.3], [22.5, 56.9]], undefined, { delayMs: 0, durationMs: 3000 }),
        PBDB('WR1', 'route', [[35.5, 50.5], [36.1, 48.6], [35.9, 42.8], [33.6, 35.5], [29.0, 29.1], [24.5, 23.9], [24.0, 19.7], [25.7, 18.2]], undefined, { delayMs: 0, durationMs: 6900 }),
        PBDB('WR2', 'route', [[9.5, 50.0], [9.7, 48.3], [11.0, 43.3], [10.9, 35.7], [9.3, 27.8], [9.0, 22.7], [9.9, 20.9], [10.7, 20.4]], undefined, { delayMs: 0, durationMs: 6900 }),
        PBDB('WR3', 'route', [[43.7, 50.9], [44.2, 48.8], [46.8, 43.1], [49.6, 35.7], [51.0, 27.2], [52.1, 18.4], [52.4, 9.2], [52.5, 1.4]], undefined, { delayMs: 0, durationMs: 6900 }),
        PBDB('TE', 'route', [[28.9, 50.4], [28.4, 48.2], [26.7, 42.6], [21.3, 39.3], [14.1, 36.6], [8.9, 32.8], [6.7, 28.7], [7.0, 25.5]], undefined, { delayMs: 0, durationMs: 6900 }),
        PBDB('RB', 'route', [[20.6, 54.0], [22.3, 53.7], [24.2, 51.5], [21.6, 48.8], [18.0, 48.9], [17.5, 48.0], [18.0, 47.0], [18.3, 46.3]], undefined, { delayMs: 0, durationMs: 6900 }),
        PBDB('CB1', 'route', [[9.9, 47.0], [9.4, 46.6], [9.1, 43.4], [9.9, 36.5], [9.1, 28.4], [8.3, 22.7], [8.9, 19.8], [9.4, 18.5]], undefined, { delayMs: 0, durationMs: 6900 }),
        PBDB('CB2', 'route', [[35.9, 47.6], [36.7, 46.9], [37.2, 42.9], [35.0, 36.2], [29.9, 29.3], [24.0, 25.3], [20.5, 21.5], [19.3, 18.6]], undefined, { delayMs: 0, durationMs: 6900 }),
        PBDB('CB3', 'route', [[44.0, 48.6], [44.2, 46.8], [46.2, 42.5], [48.3, 35.5], [50.1, 27.2], [51.0, 19.0], [51.7, 10.0], [51.9, 2.0]], undefined, { delayMs: 0, durationMs: 6900 }),
        PBDB('FS', 'route', [[21.1, 33.5], [21.8, 32.4], [22.0, 28.9], [19.0, 24.9], [15.5, 21.6], [16.6, 18.1], [18.5, 14.5], [20.0, 11.8]], undefined, { delayMs: 0, durationMs: 6900 }),
        PBDB('SS', 'route', [[29.7, 44.0], [29.4, 43.6], [27.6, 41.4], [22.3, 39.2], [15.9, 36.5], [11.0, 33.7], [9.4, 31.1], [9.9, 29.6]], undefined, { delayMs: 0, durationMs: 6900 }),
        PBDB('LB1', 'route', [[20.3, 45.4], [19.9, 46.1], [18.7, 44.7], [17.1, 42.0], [14.0, 40.8], [11.6, 38.7], [11.8, 36.0], [13.1, 34.3]], undefined, { delayMs: 0, durationMs: 6900 }),
        PBDB('LB2', 'route', [[24.3, 45.2], [25.1, 45.7], [26.4, 46.3], [23.5, 46.0], [18.5, 46.2], [15.6, 45.6], [14.4, 43.7], [14.6, 42.2]], undefined, { delayMs: 0, durationMs: 6900 }),
        PBDB('LB3', 'route', [[16.6, 48.6], [17.5, 51.5], [20.0, 57.0], [23.0, 59.8], [23.3, 60.4], [23.4, 59.3], [24.1, 58.0], [24.0, 56.8]], undefined, { delayMs: 0, durationMs: 6900 }),
        PBDB('QB', 'pass', [[23.9, 53.5], [52.0, 3.9]], 'WR3'),
      ],
      [
        { x: 31, y: 32, text: 'POST' },
        { x: 10, y: 23, text: 'GO' },
        { x: 50, y: 4.5, text: 'GO' },
        { x: 20, y: 38.5, text: 'CROSS' },
        { x: 20, y: 49.5, text: 'OUT' },
      ],
    ),
  },
]
