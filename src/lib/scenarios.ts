...
export const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    build: build(
      ...
      [
        P('QB', 'drop', [[24.2, 68.7], [24.2, 68.9], [23.8, 69.2], [23.3, 69.5], [22.3, 69.9]]),
        P('RB', 'route', [[22.1, 69.4], [22.5, 69.2], [24.9, 67.7], [26.6, 66.3], [26.4, 65.9]]),
        P('WR1', 'route', [[8.7, 65.3], [8.6, 64.1], [8.7, 62.5], [10.8, 59.4], [12.7, 58.5], [16.8, 58.2]]),
        P('WR2', 'route', [[36.4, 66.2], [37.3, 66.4], [40.6, 66.5], [43.8, 65.8], [45.4, 65.4]]),
        P('WR3', 'route', [[46.5, 66.2], [46.6, 65.8], [47.4, 63.9], [49.4, 61.2], [49.8, 57.6]]),
        P('TE', 'route', [[28.5, 65.4], [29.5, 65.4], [31.0, 66.1], [32.9, 66.2], [33.5, 66.0]]),
        P('LB1', 'route', [[26.4, 61.0], [26.9, 61.4], [27.7, 62.6], [28.6, 62.6], [30.0, 62.6]]),
        P('LB2', 'route', [[21.2, 62.2], [21.5, 63.1], [22.3, 65.3], [22.8, 67.8], [23.0, 69.4]]),
        P('CB1', 'route', [[46.3, 63.5], [46.4, 63.4], [47.0, 62.4], [49.0, 60.3], [49.9, 56.9]]),
        P('CB2', 'route', [[36.1, 63.3], [36.4, 63.2], [38.8, 63.3], [42.5, 63.9], [45.3, 64.2]]),
        P('CB3', 'route', [[8.6, 59.2], [8.5, 58.3], [8.6, 57.6], [10.5, 56.6], [12.4, 57.1], [16.8, 58.5]]),
        P('FS', 'route', [[25.9, 44.8], [26.0, 44.6], [25.6, 44.0], [23.9, 44.8], [21.5, 47.9]]),
        P('SS', 'route', [[28.8, 63.0], [28.9, 63.3], [29.0, 65.0], [29.4, 65.8], [31.3, 65.9]]),
        P('QB', 'pass', [[24.4, 69.2], [24.6, 69.2], [20.2, 64.8], [17.2, 61.8], [14.5, 59.0], [15.0, 58.1]], 'WR1'),
      ],
      [
